...
//         this.state = {editorState: EditorState.createEmpty()};
      ...
      onChange = (editorState) => {
        this.setState({editorState, text: this.refs.editor.editor.innerText});
      // console.log(this.refs.editor.editor.innerHTML);
      console.log(this.refs.editor.editor.innerText);
      this.props.getEditorValue(this.refs.editor.editor.innerText);
    };
